...
function initLegalModals() {
  ...
  const CONTENT = {
    privacy: {
      ...
      <p><strong>LOEKEMEYER HNOS S.R.L.</strong><br>
      CUIT: 30-51584245-0<br>
      Domicilio: Cervantes 2868, Ciudad Autónoma de Buenos Aires (C1417CBT), Argentina<br>
      ...
      Sitio web: <a href="https://loekemeyer.com/" target="_blank" rel="noopener">https://loekemeyer.com</a></p>
      ...
      <p><strong>LOEKEMEYER HNOS S.R.L.</strong> no comercializa ni cede datos personales a terceros con fines publicitarios.</p>
      ...
      El usuario se compromete a no difundir dicha información sin autorización expresa de <strong>LOEKEMEYER HNOS S.R.L.</strong>.</p>
      ...
      <p><strong>LOEKEMEYER HNOS S.R.L.</strong> implementa políticas de restricción de acceso a nivel de base de datos (Row Level Security), garantizando que cada usuario solo pueda acceder a la información asociada a su cuenta.</p>
      ...
      <p><strong>LOEKEMEYER HNOS S.R.L.</strong> podrá modificar la presente política en cualquier momento, publicando la versión actualizada en el sitio web.</p>`
    },
    terms: {
      ...
      <p><strong>LOEKEMEYER HNOS S.R.L.</strong> se reserva el derecho de aprobar o rechazar solicitudes de registro.</p>
      ...
      <p>Todos los contenidos del sitio (marca, imágenes, textos, diseño, código) son propiedad de <strong>LOEKEMEYER HNOS S.R.L.</strong>.
      Se prohíbe su reproducción sin autorización escrita.</p>

      <hr>

      <h4>8. LIMITACIÓN DE RESPONSABILIDAD</h4>
      <p><strong>LOEKEMEYER HNOS S.R.L.</strong> no será responsable por:</p>
      <ul>
